      ...
      <Wrapper>
        ...
        <Bottom>
          <Info>
            <Product>
              <ProductDetail>
                ...
                <Details>
                  <ProductName>
                    <b>Product:</b> DALTON THUNDER SHOES
                  </ProductName>
                  <ProductId>
                    <b>ID:</b> 977e3553ed
                  </ProductId>
            ...
            <Product>
              <ProductDetail>
                ...
                <Details>
                  <ProductName>
                    <b>Product:</b> PHILZ SUMMER TSHIRT
                  </ProductName>
                  <ProductId>
                    <b>ID:</b> 897e3gb531d
                  </ProductId>
          ...
          <Summary>
            ...
            <SummaryItem>
              <SummaryItemText>Applied Discount </SummaryItemText>
              <SummaryItemPrice>Rs -100</SummaryItemPrice>
            </SummaryItem>
            <SummaryItem type="total">
              <SummaryItemText>Total </SummaryItemText>
              <SummaryItemPrice>Rs 4050</SummaryItemPrice>
            </SummaryItem>
